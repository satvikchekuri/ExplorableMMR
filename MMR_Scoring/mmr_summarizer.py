...
def buildQuery(sentences, TF_IDF_w, n):
    ...
    # ------------ added below line-------------
    scores = sorted(TF_IDF_w.keys(),reverse=True)
...
if __name__=='__main__':	
    ...
    for folder in os.listdir(main_folder_path):
        ...
        for file in files:
            ...
            lines = lines + returnLines(curr_folder + "/" + file)
        linestring = " "
        for line in lines:
            linestring = linestring + " " + line + " "
        ...
        # query = rakeQuery(lines, int(sen_len * 0.005))
        ...
        summary = makeSummary(sentences, best1sentence, query, 0.01 * sen_len, 0.5, IDF_w)
